    ...
    <div class="relative z-10">
      <div class="flex flex-row items-center">
        ...
        <div class="title flex flex-wrap items-center gap-2 sm:gap-4 mt-5 ml-4 sm:ml-5">
          ...
          <div class="py-1 px-4 text-[#172e45] bg-white font-semibold border-1 border-black rounded-3xl inline-block text-sm lg:text-lg">
      ...
      <div class="py-4 px-4 sm:px-7 bg-[#172e45] text-white rounded-2xl inline-block ml-0 sm:ml-10 mr-0 sm:mr-5 mt-5 max-w-full">
        <h1 class="text-2xl sm:text-5xl font-semibold" style=" font-family: 'Fredoka', sans-serif;">{{ $plan->title }}</h1>
      </div>
      
      <div class="card bg-white text-black shadow-xl rounded-3xl m-4 sm:m-10">
        <div class="card-body">
...
<div class="flex flex-col lg:flex-row items-start justify-between mx-4 lg:mx-15 gap-6">
  ...
  <div class="card flex bg-white border border-1 text-base w-88 rounded-2xl mx-10 mr-15 mt-25 lg:mt-27" style="box-shadow: 4px 4px 1px 0 #4a774e;">
