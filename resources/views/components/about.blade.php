...
<div class="min-h-screen">
  ...
  <div data-aos="fade-up" data-aos-duration="1400" data-aos-delay="200">
    <div class="card bg-[#d8eedb] w-96 shadow-sm transform transition-transform duration-300 ease-in-out hover:scale-105 will-change-transform cursor-default">
      ...
      <div class="card-body">
        <h2 class="card-title text-[#19344f] font-semibold text-2xl lg:text-3xl" style="font-family: 'Quicksand', sans-serif;">Why We Exist?</h2>
        <p class="text-justify text-lg" style="font-family: 'Quicksand', sans-serif;">Karena kita capek liat bumi makin rusak tanpa solusi yang terjangkau. Di sini, semua orang bisa ikut andil. Gak perlu jadi aktivis buat peduli. Cukup jadi kamu—yang mau mulai sekarang juga.</p>
      </div>
    </div>
    </div>

  <div data-aos="fade-up" data-aos-duration="1400" data-aos-delay="400">
    <div class="card bg-[#d8eedb] w-96 shadow-sm transform transition-transform duration-300 ease-in-out hover:scale-105 l-change-transform cursor-default">
      <figure class="px-5 pt-5">
        <img
      ...
      <div class="card-body">
      <h2 class="card-title text-[#19344f] font-semibold text-2xl lg:text-3xl" style="font-family: 'Quicksand', sans-serif;">Our Mission</h2>
      <p class="text-justify text-lg pb-6" style="font-family: 'Quicksand', sans-serif;">Membantu siapa pun memulai langkah hijau, satu aksi kecil sehari demi bumi yang lebih baik. Kami percaya perubahan datang dari kamu</p>
        </div>
      </div>
  </div>

    <div data-aos="fade-up" data-aos-duration="1400" data-aos-delay="600">
      <div class="card bg-[#d8eedb] w-96 shadow-sm transform transition-transform duration-300 ease-in-out hover:scale-105 will-change-transform cursor-default">
        <figure class="px-5 pt-5">
          <img
        ...
        <div class="card-body">
          <h2 class="card-title text-[#19344f] font-semibold text-2xl lg:text-3xl" style="font-family: 'Quicksand', sans-serif;">What We Offer?</h2>
            <ul class="list-disc ml-5 text-justify text-lg pb-6" style="font-family: 'Quicksand', sans-serif;">
